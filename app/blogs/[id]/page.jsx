    ...
    <>
      ...
      <div className="mx-5 max-w-[800px] md:mx-auto -mt-24 mb-10">
        ...
        <div className="my-16">
          ...
          <div className="flex">
            <Link href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(url)}`}><Image src={assets.facebook_icon} width={45} className='mr-2 shadow-sm shadow-gray-400 rounded-full' alt="" /></Link>
            <Link href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(url)}&text=Découvrez notre article !`}> <Image src={assets.twitter_icon} width={45} className='mr-2 shadow-sm shadow-gray-400 rounded-full' alt="" /></Link>
